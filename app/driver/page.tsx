          ...
          <Card className="p-4 bg-accent/10 border-accent/20">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                <div className="font-semibold text-sm">Verification Pending</div>
                <div className="text-xs text-muted-foreground">Complete your driver profile to start earning</div>
              </div>
